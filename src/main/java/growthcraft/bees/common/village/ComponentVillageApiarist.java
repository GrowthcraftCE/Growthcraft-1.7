...
public class ComponentVillageApiarist extends StructureVillagePieces.Village implements SchemaToVillage.IVillage {
    ...
    private static final String[][] apiaristExteriorSchema = {
        {"    486  ", "xcccccccx", "cpppppppc", "cpppppppc", "cpppppppc", "cpppppppc", "xcccccccx", "ddddddd  ",
            "ddddddd  ", "ddddddd  ", "ddddddd  ", "ddddddd  ", "         ", "         "},
        {"         ", "xpppp ppx", "p       p", "B       B", "B       B", "p    8  p", "xpp ppppx", "f,,,,,f  ",
            "f,,,,,f  ", "f,+,+,f  ", "f,,,,,f  ", "ffff ff  ", "         ", "         "},
        {"         ", "xpggp ppx", "p       p", "Y       Y", "Y       Y", "p       p", "xpp pgppx", "         ",
            "         ", "t     t  ", "    H    ", "   t     ", "         ", "         "},
        {
            // the torches for this level are placed manually
            "888888888", "xpppppppx", "p       p", "B       B", "B       B", "p       p", "xpppppppx", "222222222",
            "         ", "         ", "         ", "         ", "         ", "         "},
        {"         ", "888888888", "ppppppppp", "Yp     pY", "Yp     pY", "ppppppppp", "222222222", "         ",
            "         ", "         ", "         ", "         ", "         ", "         "},
        {"         ", "         ", "788888889", "4BYBYBYB6", "4BYBYBYB6", "122222223", "         ", "         ",
            "         ", "         ", "         ", "         ", "         ", "         "}};

    private static final String[][] apiaristInteriorSchema = {{" 6    4", " 6    K", " 6    K", "p6    4"},
        {"      l", "      K", "      K", "      l"}, {" 8    l", " _    K", " _    K", " 2    l"},
        {"       ", " 2   4 ", " 8   4 ", "       "}};
    ...
    // here.
    private static final String[][] apiaristBackyardTreeSchema = {{"   ", " x ", "   ",}, {
        // bee hive appears on this level
        "   ", " x ", "   ",}, {"lll", "lxl", "lll",}, {"lll", "lxl", "lll",}, {" l ", "lxl", " l ",},
        {"   ", " l ", "   ",}};
    ...
    public ComponentVillageApiarist(Start startPiece, int par2, Random random, StructureBoundingBox boundingBox,
                                    int coordBaseMode) {
    ...
    public static ComponentVillageApiarist buildComponent(Start startPiece, List list, Random random, int x, int y,
                                                          int z, int coordBaseMode, int par7) {
        final StructureBoundingBox structureboundingbox = StructureBoundingBox
            .getComponentToAddBoundingBox(x, y, z, 0, 0, 0, 9, 8, 14, coordBaseMode);
    ...
    public boolean addComponentParts(World world, Random random, StructureBoundingBox box) {
        ...
        map.put(
            ',',
            new MultiBlockEntries(
                new BlockEntry[]{new BlockEntry(Blocks.red_flower, 4), new BlockEntry(Blocks.red_flower, 5),
                    new BlockEntry(Blocks.red_flower, 6), new BlockEntry(Blocks.red_flower, 7)}));
        ...
        map.put(
            'H',
            new BlockEntry(
                GrowthCraftBees.blocks.beeHive.getBlock(),
                this.getMetadataWithOffset(GrowthCraftBees.blocks.beeHive.getBlock(), 3)));
        map.put(
            '+',
            new BlockEntry(
                GrowthCraftBees.blocks.beeBox.getBlock(),
                this.getMetadataWithOffset(GrowthCraftBees.blocks.beeBox.getBlock(), random.nextInt(6))));
