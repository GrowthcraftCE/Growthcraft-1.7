    ...
    public void manipulateTradesForVillager(EntityVillager villager, MerchantRecipeList recipeList, Random random) {
        recipeList.add(
                new MerchantRecipe(
                        ...
                        GrowthCraftBees.fluids.honeyMeadBottle.asStack(1, 1)));
        recipeList.add(
                new MerchantRecipe(
                        new ItemStack(Items.emerald, 2 + random.nextInt(2)),
                        GrowthCraftBees.fluids.honeyMeadBottle.asStack(1, 2)));
        recipeList.add(
                new MerchantRecipe(
                        new ItemStack(Items.emerald, 2 + random.nextInt(2)),
                        GrowthCraftBees.fluids.honeyMeadBottle.asStack(1, 3)));
    }
}
