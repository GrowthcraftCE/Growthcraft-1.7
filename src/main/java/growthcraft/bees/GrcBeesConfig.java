...
public class GrcBeesConfig extends ConfigBase {
    ...
    @ConfigOption(
            catergory = "World Gen",
            name = "Biomes (IDs) That Generate Beehives",
            desc = "Separate the IDs with ';' (without the quote marks)")
    public String beeBiomesList = "1;4;18;27;28;129;132;155;156";

    @ConfigOption(
            catergory = "World Gen",
            name = "Enable Biome Dictionary compatability?",
            desc = "Default : true  || false = Disable")
    ...
    @ConfigOption(
            ...
            desc = "When the bee box has a 'bonus', what is the multiplier?")
    ...
    @ConfigOption(
            catergory = "Fluid/Honey",
            name = "Enabled",
            desc = "Should we enable honey fluid and its corresponding items?")
    ...
    @ConfigOption(
            catergory = "Village",
            name = "Spawn Village Apiarist Structure",
            desc = "Should the apiarist structure be generated in villages?")
    public boolean generateApiaristStructure;

    @ConfigOption(
            catergory = "Integration",
            name = "Enable Growthcraft Bamboo Integration",
            desc = "Should we integrate with Growthcraft Bamboo (if available)?")
    public boolean enableGrcBambooIntegration = true;

    @ConfigOption(
            catergory = "Integration",
            name = "Enable Growthcraft Nether Integration",
            desc = "Should we integrate with Growthcraft Nether (if available)?")
    ...
    @ConfigOption(
            catergory = "Integration",
            name = "Enable BiomesOPlenty Integration",
            desc = "Should we integrate with BiomesOPlenty (if available)?")
    public boolean enableBoPIntegration = true;

    @ConfigOption(
            catergory = "Integration",
            name = "Enable Natura Integration",
            desc = "Should we integrate with Natura (if available)?")
    public boolean enableNaturaIntegration = true;

    @ConfigOption(
            catergory = "Integration",
            name = "Enable Botania Integration",
            desc = "Should we integrate with Botania (if available)?")
    ...
    @ConfigOption(
            catergory = "Integration",
            name = "Enable Fossils and Archaeology Integration",
            desc = "Should we integrate with Fossils and Archaeology (if available)?")
    public boolean enableFAIntegration = true;

    @ConfigOption(
            catergory = "Integration",
            name = "Enable Ars Magica 2 Integration",
            desc = "Should we integrate with Ars Magica 2 (if available)?")
    public boolean enableAM2Integration = true;

    @ConfigOption(
            catergory = "Integration",
            name = "Enable Totemic Integration",
            desc = "Should we integrate with Totemic (if available)?")
    public boolean enableTotemicIntegration = true;

    @ConfigOption(
            catergory = "Integration",
            name = "Enable ExtraBiomesXL Integration",
            desc = "Should we integrate with ExtraBiomesXL (if available)?")
    public boolean enableEBXLIntegration = true;

    @ConfigOption(
            catergory = "Integration",
            name = "Enable Highlands Integration",
            desc = "Should we integrate with Highlands (if available)?")
