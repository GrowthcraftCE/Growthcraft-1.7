...
public class BrewingRegistry implements IBrewingRegistry {
    ...
    @Override
    public void addRecipe(@Nonnull FluidStack sourceFluid, @Nonnull Object raw, @Nonnull FluidStack resultFluid,
                          int time, @Nullable Residue residue) {
    ...
    public List<BrewingRecipe> findRecipes(@Nullable FluidStack fluid) {
        ...
        if (fluid != null) {
            for (BrewingRecipe recipe : recipes) {
                if (recipe.matchesIngredient(fluid)) result.add(recipe);
            }
        }
        return result;
    }
    ...
    public List<BrewingRecipe> findRecipes(@Nullable ItemStack fermenter) {
        ...
        if (fermenter != null) {
            for (BrewingRecipe recipe : recipes) {
                if (recipe.matchesIngredient(fermenter)) result.add(recipe);
            }
        }
        return result;
    }
