...
public class GrcApplesConfig extends ConfigBase {
    ...
    @ConfigOption(
            catergory = "Apple Tree",
            name = "Allow natural apple falling?",
            desc = "Should ripe apples fall from the tree?")
    public boolean dropRipeApples = true;

    @ConfigOption(
            catergory = "Apple Tree",
            name = "Apple natural falling rate",
            desc = "[Higher -> Less Likely to Fall]")
    ...
    @ConfigOption(
            catergory = "Village",
            name = "Generate Village Apple Farms",
            desc = "Should we spawn Apple Farms in Villages?")
