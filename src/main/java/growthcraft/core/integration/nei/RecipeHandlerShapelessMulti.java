...
public class RecipeHandlerShapelessMulti extends ShapedRecipeHandler {
    ...
    public List<CachedShapelessMultiRecipe> shapelessMultiRecipe(ShapelessMultiRecipe multiRecipe) {
        ...
        for (IMultiFluidStacks multiStack : fluidStacks) {
            ...
            for (Map.Entry<Integer, ArrayList<Object>> entry : itemsFluidMap.entrySet()) {
            ...
            if (recipesFluidStacks.size() == 0) return cachedRecipes;
        ...
        for (ArrayList<Object> recipe : recipes) {
            ...
            if (recipe.size() > 9) continue;

            cachedRecipes.add(new CachedShapelessMultiRecipe(recipe, multiRecipe.getRecipeOutput()));
        }
