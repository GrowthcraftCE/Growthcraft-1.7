...
public class RenderFenceRope implements ISimpleBlockRenderingHandler {
    ...
    public void renderInventoryBlock(Block block, int metadata, int modelID, RenderBlocks renderer) {
        if (modelID == RENDER_ID) {
            ...
            tes.addTranslation(0.0F, 0.0F, f);
            // ZPOS - Vertices
            // tessellator.setBrightness(renderer.renderMaxZ < 1.0D ? light : block.getMixedBrightnessForBlock(world, x,
            // y, z + 1));
            ...
            tes.addTranslation(f, 0.0F, 0.0F);
            // XPOS - Vertices
            // tessellator.setBrightness(renderer.renderMaxX < 1.0D ? light : block.getMixedBrightnessForBlock(world, x
            // + 1, y, z));
            ...
            tes.addTranslation(0.0F, 0.0F, -f);
            // ZNEG - Vertices
            // tessellator.setBrightness(renderer.renderMinZ > 0.0D ? light : block.getMixedBrightnessForBlock(world, x,
            // y, z - 1));
            ...
            tes.addTranslation(-f, 0.0F, 0.0F);
            // XNEG - Vertices
            // tessellator.setBrightness(renderer.renderMinX > 0.0D ? light : block.getMixedBrightnessForBlock(world, x
            // - 1, y, z));
            ...
            tes.addTranslation(0.0F, f, 0.0F);
            // Top - Vertices
            // tessellator.setBrightness(renderer.renderMaxY < 1.0D ? light : block.getMixedBrightnessForBlock(world, x,
            // y + 1, z));
            ...
            tes.addTranslation(0.0F, -f, 0.0F);
            // Bottom - Vertices
            // tessellator.setBrightness(renderer.renderMinY > 0.0D ? light : block.getMixedBrightnessForBlock(world, x,
            // y - 1, z));
            tes.addVertexWithUV(maxX, minY, maxZ, maxU, maxV);
