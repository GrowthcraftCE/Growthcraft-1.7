...
public class GrcBambooConfig extends ConfigBase {
    ...
    @ConfigOption(
            catergory = "World Gen",
            name = "Bamboo WorldGen density",
            desc = "How clustered should bamboo generate? [Higher -> Denser]")
    public int bambooWorldGenDensity = 64;

    @ConfigOption(
            catergory = "World Gen",
            name = "Bamboo WorldGen rarity",
            desc = "How rare is it for bamboo to spawn? [Higher -> Rarer]")
    public int bambooWorldGenRarity = 32;

    @ConfigOption(
            catergory = "Village",
            name = "Generate Village Bamboo Yard",
            desc = "Should we spawn Bamboo Yards in villages?")
