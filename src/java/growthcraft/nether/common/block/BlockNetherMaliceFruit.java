...
public class BlockNetherMaliceFruit extends Block implements IGrowable, ICropDataProvider
{
	...
	private final int growth = GrowthCraftNether.getConfig().maliceFruitGrowthRate;
	private final boolean dropRipeMaliceFruit = GrowthCraftNether.getConfig().dropRipeMaliceFruit;
	private final int dropChance = GrowthCraftNether.getConfig().maliceFruitDropChance;
	...
	{
		return GrowthCraftNether.blocks.netherMaliceLeaves.getBlock() == world.getBlock(x, y + 1, z) &&
	...
	{
		return GrowthCraftNether.items.netherMaliceFruit.getItem();
	}

	@Override
	public Item getItemDropped(int meta, Random random, int par3)
	{
		return meta >= MaliceFruitStage.MATURE ? GrowthCraftNether.items.netherMaliceFruit.getItem() : null;
	}
